...
<head>
	...
	<title>E-BloodBank | Donor List  </title>
...
<a href="newsm.php?vall=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want send sms to this record')"> Send SmS</a>
</td>
