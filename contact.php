...
{ ?>
            <div class="col-lg-4 mb-4">
                ...
                <div class="card">
                    <h4 class="card-header">Are you urgent ? please contact Us...</h4>
                   <p class="card-text" style="padding-left:2%">
                        <p><font color="red" ></font><br>
                    &nbsp;&nbsp;&nbsp;&nbsp;Name : <?php   echo htmlentities($result->Address); ?>
                    <br>
                </p>
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;Ph.No : <?php   echo htmlentities($result->ContactNo); ?>
                </p>
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;E-Mail :<a href="mailto:name@example.com"><?php   echo htmlentities($result->EmailId); ?>
                    </a> </p>
                </p>
                </div><br>
				<br>
